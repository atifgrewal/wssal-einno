...
class AttributeController extends Controller
{
    ...
    public function store(StoreAttributeRequest $request)
    {
        ...
        return redirect()->route('frontend.attributes.index');
    }
    ...
    public function edit(Attribute $attribute)
    {
        ...
        return view('frontend.attributes.edit', compact('attribute'));
    }
    ...
    public function show(Attribute $attribute)
    {
        ...
        $attribute->load('attributeProducts');

        return view('frontend.attributes.show', compact('attribute'));
    }
