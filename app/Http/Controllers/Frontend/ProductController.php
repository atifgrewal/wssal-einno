...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.products.create', compact('attribute_values', 'attributes', 'categories', 'sub_categories', 'tags', 'units', 'variations'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('frontend.products.edit', compact('attribute_values', 'attributes', 'categories', 'product', 'sub_categories', 'tags', 'units', 'variations'));
    }
