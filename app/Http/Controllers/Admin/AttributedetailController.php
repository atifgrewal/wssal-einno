...
class AttributedetailController extends Controller
{
    public function index()
    {
        ...
        return view('admin.attributedetails.index', compact('attributedetails'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.attributedetails.create', compact('attributes'));
    }
    ...
    public function store(StoreAttributedetailRequest $request)
    {
        ...
        return redirect()->route('admin.attributedetails.index');
    }
    ...
    public function edit(Attributedetail $attributedetail)
    {
        ...
        return view('admin.attributedetails.edit', compact('attributedetail', 'attributes'));
    }
    ...
    public function show(Attributedetail $attributedetail)
    {
        ...
        return view('admin.attributedetails.show', compact('attributedetail'));
    }
