...
class SubCatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.subCats.index', compact('product_categories', 'subCats'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.subCats.create', compact('parent_cateories'));
    }
    ...
    public function store(StoreSubCatRequest $request)
    {
        ...
        return redirect()->route('admin.sub-cats.index');
    }
    ...
    public function edit(SubCat $subCat)
    {
        ...
        return view('admin.subCats.edit', compact('parent_cateories', 'subCat'));
    }
