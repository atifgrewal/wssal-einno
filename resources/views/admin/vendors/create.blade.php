    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vendors.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('featured') ? 'is-invalid' : '' }}" name="featured" id="featured" required>
                    ...
                    @foreach(App\Models\Vendor::FEATURED_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('featured', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('promoted') ? 'is-invalid' : '' }}" name="promoted" id="promoted" required>
                    ...
                    @foreach(App\Models\Vendor::PROMOTED_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('promoted', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="number" name="phone" id="phone" value="{{ old('phone', '0') }}" step="1" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="number" name="rating" id="rating" value="{{ old('rating', '') }}" step="0.1" required max="7">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payouts') ? 'is-invalid' : '' }}" type="number" name="payouts" id="payouts" value="{{ old('payouts', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('earning') ? 'is-invalid' : '' }}" type="text" name="earning" id="earning" value="{{ old('earning', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cod_balance') ? 'is-invalid' : '' }}" type="number" name="cod_balance" id="cod_balance" value="{{ old('cod_balance', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oniline_payment') ? 'is-invalid' : '' }}" type="number" name="oniline_payment" id="oniline_payment" value="{{ old('oniline_payment', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('cid_expiry_data') ? 'is-invalid' : '' }}" type="text" name="cid_expiry_data" id="cid_expiry_data" value="{{ old('cid_expiry_data') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cid_no') ? 'is-invalid' : '' }}" type="number" name="cid_no" id="cid_no" value="{{ old('cid_no', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('opening_time') ? 'is-invalid' : '' }}" type="text" name="opening_time" id="opening_time" value="{{ old('opening_time') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('closing_time') ? 'is-invalid' : '' }}" type="text" name="closing_time" id="closing_time" value="{{ old('closing_time') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('business_type') ? 'is-invalid' : '' }}" name="business_type" id="business_type" required>
                    ...
                    @foreach(App\Models\Vendor::BUSINESS_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('business_type', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iban_no') ? 'is-invalid' : '' }}" type="text" name="iban_no" id="iban_no" value="{{ old('iban_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('swift_code') ? 'is-invalid' : '' }}" type="text" name="swift_code" id="swift_code" value="{{ old('swift_code', '') }}" required>
