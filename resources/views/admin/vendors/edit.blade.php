    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vendors.update", [$vendor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_name') ? 'is-invalid' : '' }}" type="text" name="business_name" id="business_name" value="{{ old('business_name', $vendor->business_name) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('promoted') ? 'is-invalid' : '' }}" name="promoted" id="promoted" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="number" name="phone" id="phone" value="{{ old('phone', $vendor->phone) }}" step="1" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $vendor->address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="number" name="rating" id="rating" value="{{ old('rating', $vendor->rating) }}" step="0.1" required max="7">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payouts') ? 'is-invalid' : '' }}" type="number" name="payouts" id="payouts" value="{{ old('payouts', $vendor->payouts) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('earning') ? 'is-invalid' : '' }}" type="text" name="earning" id="earning" value="{{ old('earning', $vendor->earning) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cod_balance') ? 'is-invalid' : '' }}" type="number" name="cod_balance" id="cod_balance" value="{{ old('cod_balance', $vendor->cod_balance) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oniline_payment') ? 'is-invalid' : '' }}" type="number" name="oniline_payment" id="oniline_payment" value="{{ old('oniline_payment', $vendor->oniline_payment) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('cid_expiry_data') ? 'is-invalid' : '' }}" type="text" name="cid_expiry_data" id="cid_expiry_data" value="{{ old('cid_expiry_data', $vendor->cid_expiry_data) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cid_no') ? 'is-invalid' : '' }}" type="number" name="cid_no" id="cid_no" value="{{ old('cid_no', $vendor->cid_no) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('cnic_image') ? 'is-invalid' : '' }}" id="cnic_image-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_no') ? 'is-invalid' : '' }}" type="text" name="account_no" id="account_no" value="{{ old('account_no', $vendor->account_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('opening_time') ? 'is-invalid' : '' }}" type="text" name="opening_time" id="opening_time" value="{{ old('opening_time', $vendor->opening_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('closing_time') ? 'is-invalid' : '' }}" type="text" name="closing_time" id="closing_time" value="{{ old('closing_time', $vendor->closing_time) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('business_type') ? 'is-invalid' : '' }}" name="business_type" id="business_type" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $vendor->bank_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iban_no') ? 'is-invalid' : '' }}" type="text" name="iban_no" id="iban_no" value="{{ old('iban_no', $vendor->iban_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('swift_code') ? 'is-invalid' : '' }}" type="text" name="swift_code" id="swift_code" value="{{ old('swift_code', $vendor->swift_code) }}" required>
