    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.drivers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('transport') ? 'is-invalid' : '' }}" name="transport" id="transport" required>
                    ...
                    @foreach(App\Models\Driver::TRANSPORT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('transport', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cnic_no') ? 'is-invalid' : '' }}" type="number" name="cnic_no" id="cnic_no" value="{{ old('cnic_no', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('cnic_start_date') ? 'is-invalid' : '' }}" type="text" name="cnic_start_date" id="cnic_start_date" value="{{ old('cnic_start_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('cnic_expire_date') ? 'is-invalid' : '' }}" type="text" name="cnic_expire_date" id="cnic_expire_date" value="{{ old('cnic_expire_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_balance') ? 'is-invalid' : '' }}" type="number" name="current_balance" id="current_balance" value="{{ old('current_balance', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iban_no') ? 'is-invalid' : '' }}" type="number" name="iban_no" id="iban_no" value="{{ old('iban_no', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('swift_code') ? 'is-invalid' : '' }}" type="number" name="swift_code" id="swift_code" value="{{ old('swift_code', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_orders') ? 'is-invalid' : '' }}" type="number" name="total_orders" id="total_orders" value="{{ old('total_orders', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_earning') ? 'is-invalid' : '' }}" type="number" name="total_earning" id="total_earning" value="{{ old('total_earning', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transport_no') ? 'is-invalid' : '' }}" type="text" name="transport_no" id="transport_no" value="{{ old('transport_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wal_amount') ? 'is-invalid' : '' }}" type="number" name="wal_amount" id="wal_amount" value="{{ old('wal_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_no') ? 'is-invalid' : '' }}" type="number" name="phone_no" id="phone_no" value="{{ old('phone_no', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wal_mobile_no') ? 'is-invalid' : '' }}" type="number" name="wal_mobile_no" id="wal_mobile_no" value="{{ old('wal_mobile_no', '') }}" step="0.01" required>
