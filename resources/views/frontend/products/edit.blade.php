                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.update", [$product->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="regular_price" id="regular_price" value="{{ old('regular_price', $product->regular_price) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sale_price" id="sale_price" value="{{ old('sale_price', $product->sale_price) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sku" id="sku" value="{{ old('sku', $product->sku) }}" step="1" required>
                            @if($errors->has('sku'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sku') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty" id="qty" value="{{ old('qty', $product->qty) }}" step="1" required>
                            @if($errors->has('qty'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="vendor" id="vendor" value="{{ old('vendor', $product->vendor) }}" step="1" required>
