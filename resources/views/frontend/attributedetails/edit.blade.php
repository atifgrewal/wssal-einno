    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.attributedetails.update", [$attributedetail->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="value">{{ trans('cruds.attributedetail.fields.value') }}</label>
                            <input class="form-control" type="text" name="value" id="value" value="{{ old('value', $attributedetail->value) }}" required>
                            @if($errors->has('value'))
