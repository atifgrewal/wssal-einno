                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vendors.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="phone" id="phone" value="{{ old('phone', '0') }}" step="1" required>
                            @if($errors->has('phone'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('phone') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rating" id="rating" value="{{ old('rating', '') }}" step="0.1" required max="7">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="payouts" id="payouts" value="{{ old('payouts', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="earning" id="earning" value="{{ old('earning', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cod_balance" id="cod_balance" value="{{ old('cod_balance', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="oniline_payment" id="oniline_payment" value="{{ old('oniline_payment', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="cid_expiry_data" id="cid_expiry_data" value="{{ old('cid_expiry_data') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cid_no" id="cid_no" value="{{ old('cid_no', '') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="opening_time" id="opening_time" value="{{ old('opening_time') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="closing_time" id="closing_time" value="{{ old('closing_time') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="iban_no" id="iban_no" value="{{ old('iban_no', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="swift_code" id="swift_code" value="{{ old('swift_code', '') }}" required>
