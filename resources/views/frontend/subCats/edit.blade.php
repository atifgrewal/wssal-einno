    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sub-cats.update", [$subCat->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.subCat.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $subCat->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="parent_cateory_id" id="parent_cateory_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $subCat->description) }}</textarea>
...
Dropzone.options.photoDropzone = {
    url: '{{ route('frontend.sub-cats.storeMedia') }}',
    maxFilesize: 2, // MB
